...
class Main:
    ...
    def on_main(self):
        ...
        print(f'args.input_transition : {args.input_transition}') # Example: "lesson20_projects/house3n2/auto_gen/data/transition3.json"
        print(f'args.import_module : {args.import_module}') # Example: "lesson23_projects.house3n2.auto_gen.data.const"
